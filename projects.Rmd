...
### Twitter Hate Speech Classifier in Pyspark
...
In this project, my group and I aimed to classify tweets from a 25,000 tweet dataset as hate, offensive, or regular speech using PySpark. Using cross-validation on a naive-bayes and logistic regression model, we were able to decide on a logistic regression model with stop words removed from the tweets. Using this model, we were able to achieve an overall accuracy of 88.38% on the test set. In this project, I did most of the development on the Logistic Regression model and final analysis in the report.

<br>

### New York Airbnb Price Regression and Median Price Classification
...
### Unsupervised Cluster Analysis of NCAA D1 Curveballs 
...
### Batting Point of Contact Analysis 
...
### Exploring the Relationship Between Spin Rate and Pitch Velocity
